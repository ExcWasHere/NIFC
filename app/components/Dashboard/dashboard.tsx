                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div
                          className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${interaction.color} rounded-2xl flex items-center justify-center mr-3 sm:mr-4 shadow-md`}
                        >
                          <span className="text-white font-bold text-xs sm:text-sm">
                            {interaction.avatar}
                          </span>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-white/20 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              >
                ...
                <span className="text-xs sm:text-sm text-sky-100 mt-2">
              ...
              >
                ...
                <span className="text-xs sm:text-sm text-cyan-100 mt-2">
                  Get instant support
                </span>
              </a>
              <a
          ...
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex items-center space-x-6 sm:space-x-8">
                <a
                  href="/about-us"
                  className="text-xs sm:text-sm text-sky-600 hover:text-sky-800 transition-colors font-semibold"
                >
                  About-Us
                </a>
                <a
                  href="https://linktr.ee/Sembiru"
                  className="text-xs sm:text-sm text-sky-600 hover:text-sky-800 transition-colors font-semibold"
                >
                  Bantuan
                </a>
