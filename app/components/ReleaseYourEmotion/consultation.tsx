...
const psychologists = [
  {
    ...
    online: true,
    description:
      "Psikolog klinis berpengalaman dengan fokus pada terapi kognitif behavioral dan trauma healing. Telah menangani lebih dari 500 kasus dengan tingkat kesuksesan tinggi.",
    ...
    reviews: [
      {
        name: "Sarah M.",
        rating: 5,
        comment: "Sangat membantu dan profesional. Terima kasih Dr. Anita!",
      },
      {
        name: "Ahmad R.",
        rating: 5,
        comment:
          "Pendekatan yang sangat baik, saya merasa lebih baik setelah konsultasi.",
      },
    ],
  },
  {
    ...
    online: false,
    description:
      "Spesialis dalam terapi keluarga dan manajemen stress. Menggunakan pendekatan holistik untuk membantu klien mencapai keseimbangan hidup.",
    ...
    reviews: [
      {
        name: "Lisa K.",
        rating: 5,
        comment: "Dr. Budi sangat memahami masalah keluarga kami.",
      },
      {
        name: "Andi P.",
        rating: 4,
        comment: "Sesi yang produktif, akan lanjut konsultasi.",
      },
    ],
  },
];
...
const ConsultationPage = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      ...
      sender: "doctor",
      message:
        "Halo! Selamat datang di sesi konsultasi. Ada yang bisa saya bantu hari ini?",
      time: "10:00",
    },
  ]);
  ...
  if (newMessage.trim()) {
    ...
    const newMsg = {
      id: Date.now(), // lebih aman pakai timestamp daripada length
      sender: "user",
      message: newMessage,
      time: currentTime,
    };
    ...
    setTimeout(() => {
      const doctorResponse = {
        ...
        sender: "doctor",
        message:
          "Terima kasih sudah berbagi. Saya memahami situasi Anda. Mari kita diskusikan lebih lanjut...",
  ...
  const SidebarItem = ({ item }) => (
    ...
    >
      <div
        className={`w-9 h-9 rounded-lg flex items-center justify-center mr-3 shadow-md ${
          item.id === activeTab
            ...
            <div className="ml-6 flex-1">
              ...
              <div className="flex items-center mt-2 text-yellow-500">
                ...
                <span className="text-gray-500 ml-1">
                  ({selectedDoctor?.reviewCount} ulasan)
                </span>
              </div>
            </div>
          </div>
      ...
      <main className="lg:ml-64 p-6">
        <header className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Cari dan hubungi psikolog profesional
          </p>
        </header>
