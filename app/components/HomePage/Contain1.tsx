...
const heroContent: SlideContent[] = [
  {
    id: 1,
    title: "Mencegah Gangguan Mental di Indonesia",
    subtitle: "Inovasi Digital untuk Indonesia",
    category: "Visi",
    image: "NIFC1.jpg",
  },
  {
  ...
  return (
    <div className="relative h-[calc(100vh-4rem)] md:h-screen w-full mx-auto overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="h-full w-full absolute inset-0 bg-gradient-to-t from-sky-400 via-transparent to-transparent opacity-30" />
